...
**Gráfico de Pizza**: É um círculo dividido em pedaços. Cada pedaço representa um valor numérico que tem tamanho proporcional ao seu valor. Esse, é um gáfico que devemos tomar muito cuidado ao utiliza-lo, sendo recomendado apenas se tivermos duas categorias, pois mais que isso perdemos a noção visual do quanto uma parte do gráfico é maior que outra.
<br>
Fazendo o mesmo exemplo para o gráfico de pizza, notaremos que é mais fácil perceber a diferença da frequência entre 4 e 6 cilindros.
