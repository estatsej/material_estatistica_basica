...
**Histograma**: É um gráfico utilizado para variáveis quantitativas contínuas, sendo constituído de barras uma ao lado da outro, continuando usando o mesmo banco, agora queremos verificar a distribuição do peso dos carros.
